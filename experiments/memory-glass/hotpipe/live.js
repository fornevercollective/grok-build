/* Memory Glass hotpipe/live.js v16-path
 * Daito/Rhizomatiks-style PATH CONTRAILS for movement estimation
 * (fencing tip trails · velocity-colored · multi-tip: nose / gaze / chin)
 * + v15 spatial lock · mesh α · person matte · zone assign
 * Main browser stays PAGE-calm
 */
(function () {
  "use strict";
  var HP = (window.__mgHotPipe = window.__mgHotPipe || {});
  var VER = "live-v16-path";
  var MAX_FACES = 4;
  ...
  if (isMain) {
    if (!HP._mainPro15) {
      ...
      ok("main calm · calibration on inspect · " + VER);
    }
    if (!isInspect) return;
  }
  ...
  ok("PATH contrails · fencing tip · spatial lock · mesh · " + VER);
  tick();
