...
(function () {
  ...
  var FLEET_SEED = [
    {
      id: "fleet-mini-agent-30-turbo-588",
      kind: "agent_end",
      t: 1785611280000,
      iso: "2026-08-01T20:28:00Z",
      game: "webgrid",
      score: 7678.6,
      synopsis:
        "WebGrid 30 · Mac mini M4 agent RACE-SHELL turbo · 588.40 BPS / 3598 NTPM · 30×30 · 4129 clicks · score 7678.6",
      metrics: {
        t: 1785611280000,
        iso: "2026-08-01T20:28:00Z",
        game: "webgrid",
    ...
    {
      id: "fleet-mini-agent-30-race-554",
      kind: "agent_end",
      t: 1785611000000,
      iso: "2026-08-01T20:10:00Z",
      game: "webgrid",
      score: 7234.8,
      synopsis:
        "WebGrid 30 · Mac mini M4 agent race v33 · 554.39 BPS / 3390 NTPM · 30×30 · 3962 clicks · score 7234.8",
      metrics: {
        t: 1785611000000,
        iso: "2026-08-01T20:10:00Z",
        game: "webgrid",
  ...
  function ensureCss() {
    ...
    st.textContent = [
      ...
      "html.mg-inspect-host #mg-sys{position:relative;z-index:50!important;order:0!important}",
      "html.mg-inspect-host #mg-activity-board{z-index:20!important}",
