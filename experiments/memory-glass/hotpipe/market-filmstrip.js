...
(function () {
  ...
  function ensureStyles() {
    ...
    st.id = "mg-mkt-css";
    st.textContent = [
      "#mg-mkt-rail{position:fixed;top:48px;right:0;z-index:120;display:flex;flex-direction:row-reverse;",
      ...
      "  appearance:none;cursor:pointer;border:1px solid rgba(120,200,160,0.4);",
      "  background:rgba(8,14,12,0.94);color:rgba(160,240,200,0.92);padding:10px 6px;",
      ...
      "  background:rgba(6,10,12,0.96);border-left:1px solid rgba(100,180,140,0.28);",
      "  color:rgba(210,230,220,0.92);display:flex;flex-direction:column;max-height:calc(100vh - 56px)}",
      ...
      "  border-bottom:1px solid rgba(100,160,140,0.22);letter-spacing:0.1em;text-transform:uppercase}",
      ...
      "#mg-mkt-acts button{appearance:none;cursor:pointer;border:1px solid rgba(120,180,150,0.35);",
      "  background:rgba(12,20,16,0.95);color:inherit;padding:5px 7px;border-radius:3px;",
      ...
      "#mg-mkt-list .sym{color:rgba(160,240,200,0.95)}",
